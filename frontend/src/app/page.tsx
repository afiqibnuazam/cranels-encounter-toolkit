  ...
  return (
    <div className="grid grid-cols-4 gap-4 h-[calc(100vh-84px)]">
      ...
      <div className="bg-primary-foreground p-4 rounded-lg">
        <h1 className="text-lg font-light mb-4">Battle Log</h1>
      ...
      <div className="bg-primary-foreground p-4 rounded-lg col-span-2">
        <h1 className="text-lg font-light mb-4">Combatants by Initiative</h1>
        <EncounterTable />
      </div>
      ...
      <div className="bg-primary-foreground p-4 rounded-lg">
        ...
        <h1 className="text-lg font-light mb-4">Selected Combatant</h1>
        {/* COLLAPSIBLE */}
        <div className="relative overflow-hidden bg-gray-200">
          {/* Image and Name */}
